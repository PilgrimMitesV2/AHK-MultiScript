...
ButtonHandler:
    if (GuiVisible) {
        ...
        Switch A_GuiControl
        {
            ...
            Case "Save Extras":
                MsgBox, 4, Do you want to Save?, TurnAround Toggle: %TurnAroundT%`nTurn Around Key: %key_180%`nRCS Safety Toggle: %RecoilSafety%`nRCS Safety Key: %Key_Safety%`nCrouch Correction Toggle: %DuckT%`nSpeech Toggle: %SpeechT%`nCounter Strafe: %CounterStrafeT%`n Quick reload: %ReloadT%`n SniperQQL %SniperQQ%
                IfMsgBox Yes
                    Saving := [[Key_180, "Hotkeys", "Key_180"], [TurnAroundT, "Toggle", "TurnAroundT"], [Key_Safety, "Hotkeys", "Key_Safety"], [RecoilSafety, "Toggle", "RecoilSafety"], [SpeechT, "Toggle", "SpeechT"], [CounterStrafeT, "Toggle", "CounterStrafeT"], [SniperQQ, "Toggle", "SniperQQ"], [Gunreload, "Toggle", "ReloadT"]]
                    for index, Save in Saving {
                        CustomSave(Save.1, Save.2, Save.3)
                    }
                    Goto GuiClose
